...
namespace dgtk.OpenGL
{
	internal static class delegatesGL
	{
		...
		internal delegate uint glPathGlyphIndexRangeNV(uint fontTarget, IntPtr fontName, PathFontStyle fontStyle, uint pathParameterTemplate, float emScale, uint baseAndCount);
		...
		internal delegate void glTexImage2DMultisampleCoverageNV(TextureTarget target, int coverageSamples, int colorSamples, int internalFormat, int width, int height, Boolean fixedSampleLocations);
		...
		internal delegate void glTexImage3DMultisampleCoverageNV(TextureTarget target, int coverageSamples, int colorSamples, int internalFormat, int width, int height, int depth, Boolean fixedSampleLocations);
		...
		internal delegate void glTexStorage2DMultisample(TextureTarget target, int samples, InternalFormat internalformat, int width, int height, Boolean fixedsamplelocations);
		...
		internal delegate void glTexStorage3DMultisample(TextureTarget target, int samples, InternalFormat internalformat, int width, int height, int depth, Boolean fixedsamplelocations);
		internal delegate void glTexStorage3DMultisampleOES(TextureTarget target, int samples, InternalFormat internalformat, int width, int height, int depth, Boolean fixedsamplelocations);
		...
		internal delegate void glTexStorageMem2DMultisampleEXT(TextureTarget target, int samples, uint internalFormat, int width, int height, Boolean fixedSampleLocations, uint memory, ulong offset);
		...
		internal delegate void glTexStorageMem3DMultisampleEXT(TextureTarget target, int samples, uint internalFormat, int width, int height, int depth, Boolean fixedSampleLocations, uint memory, ulong offset);
		internal delegate void glTexStorageSparseAMD(TextureTarget target, InternalFormat internalFormat, int width, int height, int depth, int layers, TextureStorageMaskAMD flags);
		...
		internal delegate void glTextureImage2DMultisampleCoverageNV(uint texture, TextureTarget target, int coverageSamples, int colorSamples, int internalFormat, int width, int height, Boolean fixedSampleLocations);
		internal delegate void glTextureImage2DMultisampleNV(uint texture, TextureTarget target, int samples, int internalFormat, int width, int height, Boolean fixedSampleLocations);
		...
		internal delegate void glTextureImage3DMultisampleCoverageNV(uint texture, TextureTarget target, int coverageSamples, int colorSamples, int internalFormat, int width, int height, int depth, Boolean fixedSampleLocations);
		internal delegate void glTextureImage3DMultisampleNV(uint texture, TextureTarget target, int samples, int internalFormat, int width, int height, int depth, Boolean fixedSampleLocations);
		...
		internal delegate void glTextureStorage2DMultisample(uint texture, int samples, InternalFormat internalformat, int width, int height, Boolean fixedsamplelocations);
		internal delegate void glTextureStorage2DMultisampleEXT(uint texture, TextureTarget target, int samples, InternalFormat internalformat, int width, int height, Boolean fixedsamplelocations);
		...
		internal delegate void glTextureStorage3DMultisample(uint texture, int samples, InternalFormat internalformat, int width, int height, int depth, Boolean fixedsamplelocations);
		internal delegate void glTextureStorage3DMultisampleEXT(uint texture, uint target, int samples, InternalFormat internalformat, int width, int height, int depth, Boolean fixedsamplelocations);
		...
		internal delegate void glTextureStorageMem2DMultisampleEXT(uint texture, int samples, uint internalFormat, int width, int height, Boolean fixedSampleLocations, uint memory, ulong offset);
		...
		internal delegate void glTextureStorageMem3DMultisampleEXT(uint texture, int samples, uint internalFormat, int width, int height, int depth, Boolean fixedSampleLocations, uint memory, ulong offset);
		internal delegate void glTextureStorageSparseAMD(uint texture, uint target, InternalFormat internalFormat, int width, int height, int depth, int layers, TextureStorageMaskAMD flags);
