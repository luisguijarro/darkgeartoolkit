...
namespace dgtk.OpenGL
{
	internal static class delegatesGL
	{
		...
		internal delegate void glActiveStencilFaceEXT(TriangleFace face);
		...
		internal delegate void glAlphaFragmentOp1ATI(FragmentOp1ATI op, FragmentShaderRegATI dst, FragmentShaderDestModMaskATI dstMod, FragmentShaderGenericSourceATI arg1, FragmentShaderValueRepATI arg1Rep, FragmentShaderColorModMaskATI arg1Mod);
		internal delegate void glAlphaFragmentOp2ATI(FragmentOp2ATI op, FragmentShaderRegATI dst, FragmentShaderDestModMaskATI dstMod, FragmentShaderGenericSourceATI arg1, FragmentShaderValueRepATI arg1Rep, FragmentShaderColorModMaskATI arg1Mod, FragmentShaderGenericSourceATI arg2, FragmentShaderValueRepATI arg2Rep, FragmentShaderColorModMaskATI arg2Mod);
		internal delegate void glAlphaFragmentOp3ATI(FragmentOp3ATI op, FragmentShaderRegATI dst, FragmentShaderDestModMaskATI dstMod, FragmentShaderGenericSourceATI arg1, FragmentShaderValueRepATI arg1Rep, FragmentShaderColorModMaskATI arg1Mod, FragmentShaderGenericSourceATI arg2, FragmentShaderValueRepATI arg2Rep, FragmentShaderColorModMaskATI arg2Mod, FragmentShaderGenericSourceATI arg3, FragmentShaderValueRepATI arg3Rep, FragmentShaderColorModMaskATI arg3Mod);
		...
		internal delegate uint glBindMaterialParameterEXT(TriangleFace face, MaterialParameter value);
		...
		internal delegate void glColorFormatNV(int size, ColorPointerType type, int stride);
		internal delegate void glColorFragmentOp1ATI(FragmentOp1ATI op, FragmentShaderRegATI dst, FragmentShaderDestMaskATI dstMask, FragmentShaderDestModMaskATI dstMod, FragmentShaderGenericSourceATI arg1, FragmentShaderValueRepATI arg1Rep, FragmentShaderColorModMaskATI arg1Mod);
		internal delegate void glColorFragmentOp2ATI(FragmentOp2ATI op, FragmentShaderRegATI dst, FragmentShaderDestMaskATI dstMask, FragmentShaderDestModMaskATI dstMod, FragmentShaderGenericSourceATI arg1, FragmentShaderValueRepATI arg1Rep, FragmentShaderColorModMaskATI arg1Mod, FragmentShaderGenericSourceATI arg2, FragmentShaderValueRepATI arg2Rep, FragmentShaderColorModMaskATI arg2Mod);
		internal delegate void glColorFragmentOp3ATI(FragmentOp3ATI op, FragmentShaderRegATI dst, FragmentShaderDestMaskATI dstMask, FragmentShaderDestModMaskATI dstMod, FragmentShaderGenericSourceATI arg1, FragmentShaderValueRepATI arg1Rep, FragmentShaderColorModMaskATI arg1Mod, FragmentShaderGenericSourceATI arg2, FragmentShaderValueRepATI arg2Rep, FragmentShaderColorModMaskATI arg2Mod, FragmentShaderGenericSourceATI arg3, FragmentShaderValueRepATI arg3Rep, FragmentShaderColorModMaskATI arg3Mod);
		...
		internal delegate void glColorMaterial(TriangleFace face, ColorMaterialParameter mode);
		...
		internal unsafe delegate void glColorTableParameterfv(ColorTableTarget target, ColorTableParameterPName pname, float* @params);
		internal unsafe delegate void glColorTableParameterfvSGI(ColorTableTargetSGI target, ColorTableParameterPName pname, float* @params);
		internal unsafe delegate void glColorTableParameteriv(ColorTableTarget target, ColorTableParameterPName pname, int* @params);
		internal unsafe delegate void glColorTableParameterivSGI(ColorTableTargetSGI target, ColorTableParameterPName pname, int* @params);
		...
		internal delegate void glConvolutionParameterf(ConvolutionTarget target, ConvolutionParameter pname, float @params);
		internal delegate void glConvolutionParameterfEXT(ConvolutionTargetEXT target, ConvolutionParameter pname, float @params);
		internal unsafe delegate void glConvolutionParameterfv(ConvolutionTarget target, ConvolutionParameter pname, float* @params);
		internal unsafe delegate void glConvolutionParameterfvEXT(ConvolutionTargetEXT target, ConvolutionParameter pname, float* @params);
		internal delegate void glConvolutionParameteri(ConvolutionTarget target, ConvolutionParameter pname, int @params);
		internal delegate void glConvolutionParameteriEXT(ConvolutionTargetEXT target, ConvolutionParameter pname, int @params);
		internal unsafe delegate void glConvolutionParameteriv(ConvolutionTarget target, ConvolutionParameter pname, int* @params);
		internal unsafe delegate void glConvolutionParameterivEXT(ConvolutionTargetEXT target, ConvolutionParameter pname, int* @params);
		...
		internal delegate void glDrawElementsInstancedBaseInstance(PrimitiveType mode, int count, DrawElementsType type, IntPtr indices, int instancecount, uint baseinstance);
		...
		internal delegate void glFragmentColorMaterialSGIX(TriangleFace face, MaterialParameter mode);
		...
		internal delegate void glFragmentMaterialfSGIX(TriangleFace face, MaterialParameter pname, float param);
		internal unsafe delegate void glFragmentMaterialfvSGIX(TriangleFace face, MaterialParameter pname, float* @params);
		internal delegate void glFragmentMaterialiSGIX(TriangleFace face, MaterialParameter pname, int param);
		internal unsafe delegate void glFragmentMaterialivSGIX(TriangleFace face, MaterialParameter pname, int* @params);
		...
		internal unsafe delegate void glGetColorTableParameterfv(ColorTableTarget target, ColorTableParameterPName pname, float* @params);
		internal unsafe delegate void glGetColorTableParameterfvEXT(ColorTableTarget target, ColorTableParameterPName pname, float* @params);
		internal unsafe delegate void glGetColorTableParameterfvSGI(ColorTableTargetSGI target, ColorTableParameterPName pname, float* @params);
		internal unsafe delegate void glGetColorTableParameteriv(ColorTableTarget target, ColorTableParameterPName pname, int* @params);
		internal unsafe delegate void glGetColorTableParameterivEXT(ColorTableTarget target, ColorTableParameterPName pname, int* @params);
		internal unsafe delegate void glGetColorTableParameterivSGI(ColorTableTargetSGI target, ColorTableParameterPName pname, int* @params);
		...
		internal delegate uint glGetCommandHeaderNV(CommandOpcodesNV tokenID, uint size);
		...
		internal unsafe delegate void glGetConvolutionParameterfv(ConvolutionTarget target, ConvolutionParameter pname, float* @params);
		internal unsafe delegate void glGetConvolutionParameterfvEXT(ConvolutionTargetEXT target, ConvolutionParameter pname, float* @params);
		internal unsafe delegate void glGetConvolutionParameteriv(ConvolutionTarget target, ConvolutionParameter pname, int* @params);
		internal unsafe delegate void glGetConvolutionParameterivEXT(ConvolutionTargetEXT target, ConvolutionParameter pname, int* @params);
		...
		internal unsafe delegate void glGetFragmentMaterialfvSGIX(TriangleFace face, MaterialParameter pname, float* @params);
		internal unsafe delegate void glGetFragmentMaterialivSGIX(TriangleFace face, MaterialParameter pname, int* @params);
		...
		internal delegate uint glGetHandleARB(ContainerType pname);
		...
		internal unsafe delegate void glGetMaterialiv(TriangleFace face, MaterialParameter pname, int* @params);
		...
		internal delegate void glGetnHistogram(HistogramTarget target, bool reset, PixelFormat format, PixelType type, int bufSize, IntPtr values);
		...
		internal delegate void glGetnMinmax(MinmaxTarget target, bool reset, PixelFormat format, PixelType type, int bufSize, IntPtr values);
		...
		internal delegate void glHintPGI(HintTargetPGI target, VertexHintsMaskPGI mode);
		...
		internal delegate void glIndexMaterialEXT(TriangleFace face, IndexMaterialParameterEXT mode);
		...
		internal delegate void glLightEnviSGIX(LightEnvParameterSGIX pname, LightEnvModeSGIX param);
		...
		internal delegate void glMateriali(TriangleFace face, MaterialParameter pname, int param);
		internal unsafe delegate void glMaterialiv(TriangleFace face, MaterialParameter pname, int* @params);
		...
		internal delegate void glNamedBufferData(uint buffer, int size, IntPtr data, BufferUsageARB usage);
		internal delegate void glNamedBufferDataEXT(uint buffer, int size, IntPtr data, BufferUsageARB usage);
		...
		internal delegate void glPassTexCoordATI(FragmentShaderRegATI dst, FragmentShaderTextureSourceATI coord, SwizzleOpATI swizzle);
		...
		internal delegate void glPolygonMode(TriangleFace face, PolygonMode mode);
		...
		internal delegate void glReplacementCodeuiColor3fVertex3fSUN(TriangleListSUN rc, float r, float g, float b, float x, float y, float z);
		internal unsafe delegate void glReplacementCodeuiColor3fVertex3fvSUN(TriangleListSUN* rc, float* c, float* v);
		internal delegate void glReplacementCodeuiColor4fNormal3fVertex3fSUN(TriangleListSUN rc, float r, float g, float b, float a, float nx, float ny, float nz, float x, float y, float z);
		internal unsafe delegate void glReplacementCodeuiColor4fNormal3fVertex3fvSUN(TriangleListSUN* rc, float* c, float* n, float* v);
		internal delegate void glReplacementCodeuiColor4ubVertex3fSUN(TriangleListSUN rc, byte r, byte g, byte b, byte a, float x, float y, float z);
		internal unsafe delegate void glReplacementCodeuiColor4ubVertex3fvSUN(TriangleListSUN* rc, byte* c, float* v);
		internal delegate void glReplacementCodeuiNormal3fVertex3fSUN(TriangleListSUN rc, float nx, float ny, float nz, float x, float y, float z);
		internal unsafe delegate void glReplacementCodeuiNormal3fVertex3fvSUN(TriangleListSUN* rc, float* n, float* v);
		internal delegate void glReplacementCodeuiSUN(TriangleListSUN code);
		internal delegate void glReplacementCodeuiTexCoord2fColor4fNormal3fVertex3fSUN(TriangleListSUN rc, float s, float t, float r, float g, float b, float a, float nx, float ny, float nz, float x, float y, float z);
		internal unsafe delegate void glReplacementCodeuiTexCoord2fColor4fNormal3fVertex3fvSUN(TriangleListSUN* rc, float* tc, float* c, float* n, float* v);
		internal delegate void glReplacementCodeuiTexCoord2fNormal3fVertex3fSUN(TriangleListSUN rc, float s, float t, float nx, float ny, float nz, float x, float y, float z);
		internal unsafe delegate void glReplacementCodeuiTexCoord2fNormal3fVertex3fvSUN(TriangleListSUN* rc, float* tc, float* n, float* v);
		internal delegate void glReplacementCodeuiTexCoord2fVertex3fSUN(TriangleListSUN rc, float s, float t, float x, float y, float z);
		internal unsafe delegate void glReplacementCodeuiTexCoord2fVertex3fvSUN(TriangleListSUN* rc, float* tc, float* v);
		internal delegate void glReplacementCodeuiVertex3fSUN(TriangleListSUN rc, float x, float y, float z);
		internal unsafe delegate void glReplacementCodeuiVertex3fvSUN(TriangleListSUN* rc, float* v);
		internal unsafe delegate void glReplacementCodeuivSUN(TriangleListSUN* code);
		...
		internal delegate void glSampleMapATI(FragmentShaderRegATI dst, FragmentShaderTextureSourceATI interp, SwizzleOpATI swizzle);
		...
		internal unsafe delegate void glSetFragmentShaderConstantATI(FragmentShaderConATI dst, float* value);
		...
		internal delegate void glSpriteParameteriSGIX(SpriteParameterNameSGIX pname, SpriteModeSGIX param);
		internal unsafe delegate void glSpriteParameterivSGIX(SpriteParameterNameSGIX pname, SpriteModeSGIX* @params);
		...
		internal delegate void glStencilOpSeparateATI(TriangleFace face, StencilOp sfail, StencilOp dpfail, StencilOp dppass);
		internal delegate void glStencilOpValueAMD(TriangleFace face, uint value);
		...
		internal delegate void glTexImage2DMultisampleCoverageNV(TextureTarget target, int coverageSamples, int colorSamples, InternalFormat internalFormat, int width, int height, bool fixedSampleLocations);
		...
		internal delegate void glTexImage3DMultisampleCoverageNV(TextureTarget target, int coverageSamples, int colorSamples, InternalFormat internalFormat, int width, int height, int depth, bool fixedSampleLocations);
		...
		internal delegate void glTextureImage2DMultisampleCoverageNV(uint texture, TextureTarget target, int coverageSamples, int colorSamples, InternalFormat internalFormat, int width, int height, bool fixedSampleLocations);
		internal delegate void glTextureImage2DMultisampleNV(uint texture, TextureTarget target, int samples, InternalFormat internalFormat, int width, int height, bool fixedSampleLocations);
		...
		internal delegate void glTextureImage3DMultisampleCoverageNV(uint texture, TextureTarget target, int coverageSamples, int colorSamples, InternalFormat internalFormat, int width, int height, int depth, bool fixedSampleLocations);
		internal delegate void glTextureImage3DMultisampleNV(uint texture, TextureTarget target, int samples, InternalFormat internalFormat, int width, int height, int depth, bool fixedSampleLocations);
		internal delegate void glTextureLightEXT(LightTexturePNameEXT pname);
		internal delegate void glTextureMaterialEXT(TriangleFace face, MaterialParameter mode);
		...
		internal delegate void glTextureStorage2DMultisample(uint texture, int samples, SizedInternalFormat internalformat, int width, int height, bool fixedsamplelocations);
		internal delegate void glTextureStorage2DMultisampleEXT(uint texture, TextureTarget target, int samples, SizedInternalFormat internalformat, int width, int height, bool fixedsamplelocations);
		...
		internal delegate void glTextureStorage3DMultisample(uint texture, int samples, SizedInternalFormat internalformat, int width, int height, int depth, bool fixedsamplelocations);
		internal delegate void glTextureStorage3DMultisampleEXT(uint texture, uint target, int samples, SizedInternalFormat internalformat, int width, int height, int depth, bool fixedsamplelocations);
		...
		internal unsafe delegate void glTransformFeedbackVaryingsEXT(uint program, int count, string[] varyings, TransformFeedbackBufferMode bufferMode);
		internal unsafe delegate void glTransformFeedbackVaryingsNV(uint program, int count, TransformFeedbackTokenNV* locations, TransformFeedbackBufferMode bufferMode);
