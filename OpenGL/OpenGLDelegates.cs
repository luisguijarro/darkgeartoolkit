...
namespace dgtk.OpenGL
{
	internal static class delegatesGL
	{
		...
		internal unsafe delegate uint glGetDebugMessageLogAMD(uint count, int bufSize, uint* categories, DebugSeverity* severities, uint* ids, int* lengths, sbyte* message);
