...
namespace dgtk.OpenGL
{
	internal static class delegatesGL
	{
		...
		internal unsafe delegate bool glAreProgramsResidentNV(int n, uint* programs, Boolean* residences);
		internal unsafe delegate bool glAreTexturesResident(int n, uint* textures, Boolean* residences);
		internal unsafe delegate bool glAreTexturesResidentEXT(int n, uint* textures, Boolean* residences);
		...
		internal delegate void glBindImageTextureEXT(uint index, uint texture, int level, Boolean layered, int layer, BufferAccessARB access, int format);
		...
		internal delegate void glBlitFramebufferEXT(int srcX0, int srcY0, int srcX1, int srcY1, int dstX0, int dstY0, int dstX1, int dstY1, ClearBufferMask mask, BlitFramebufferFilter filter);
		...
		internal delegate void glBlitNamedFramebuffer(uint readFramebuffer, uint drawFramebuffer, int srcX0, int srcY0, int srcX1, int srcY1, int dstX0, int dstY0, int dstX1, int dstY1, ClearBufferMask mask, BlitFramebufferFilter filter);
		...
		internal delegate void glClearBufferData(BufferStorageTarget target, SizedInternalFormat internalformat, PixelFormat format, PixelType type, IntPtr data);
		...
		internal delegate void glClearBufferSubData(BufferTargetARB target, SizedInternalFormat internalformat, IntPtr offset, int size, PixelFormat format, PixelType type, IntPtr data);
		...
		internal delegate void glClearNamedBufferData(uint buffer, SizedInternalFormat internalformat, PixelFormat format, PixelType type, IntPtr data);
		internal delegate void glClearNamedBufferDataEXT(uint buffer, SizedInternalFormat internalformat, PixelFormat format, PixelType type, IntPtr data);
		internal delegate void glClearNamedBufferSubData(uint buffer, SizedInternalFormat internalformat, IntPtr offset, int size, PixelFormat format, PixelType type, IntPtr data);
		internal delegate void glClearNamedBufferSubDataEXT(uint buffer, SizedInternalFormat internalformat, int offset, int size, PixelFormat format, PixelType type, IntPtr data);
		...
		internal delegate void glClientAttribDefaultEXT(ClientAttribMask mask);
		...
		internal delegate void glColorMaskiEXT(uint index, Boolean r, Boolean g, Boolean b, Boolean a);
		internal delegate void glColorMaskIndexedEXT(uint index, Boolean r, Boolean g, Boolean b, Boolean a);
		internal delegate void glColorMaskiOES(uint index, Boolean r, Boolean g, Boolean b, Boolean a);
		...
		internal delegate void glCombinerOutputNV(CombinerStageNV stage, CombinerPortionNV portion, CombinerRegisterNV abOutput, CombinerRegisterNV cdOutput, CombinerRegisterNV sumOutput, CombinerScaleNV scale, CombinerBiasNV bias, Boolean abDotProduct, Boolean cdDotProduct, Boolean muxSum);
		...
		internal delegate void glCompressedMultiTexSubImage1DEXT(TextureUnit texunit, TextureTarget target, int level, int xoffset, int width, InternalFormat format, int imageSize, IntPtr bits);
		internal delegate void glCompressedMultiTexSubImage2DEXT(TextureUnit texunit, TextureTarget target, int level, int xoffset, int yoffset, int width, int height, InternalFormat format, int imageSize, IntPtr bits);
		internal delegate void glCompressedMultiTexSubImage3DEXT(TextureUnit texunit, TextureTarget target, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth, InternalFormat format, int imageSize, IntPtr bits);
		...
		internal delegate void glCompressedTexSubImage1D(TextureTarget target, int level, int xoffset, int width, InternalFormat format, int imageSize, IntPtr data);
		internal delegate void glCompressedTexSubImage1DARB(TextureTarget target, int level, int xoffset, int width, InternalFormat format, int imageSize, IntPtr data);
		...
		internal delegate void glCompressedTexSubImage2DARB(TextureTarget target, int level, int xoffset, int yoffset, int width, int height, InternalFormat format, int imageSize, IntPtr data);
		...
		internal delegate void glCompressedTexSubImage3DARB(TextureTarget target, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth, InternalFormat format, int imageSize, IntPtr data);
		...
		internal delegate void glCompressedTextureSubImage1D(uint texture, int level, int xoffset, int width, InternalFormat format, int imageSize, IntPtr data);
		internal delegate void glCompressedTextureSubImage1DEXT(uint texture, TextureTarget target, int level, int xoffset, int width, InternalFormat format, int imageSize, IntPtr bits);
		internal delegate void glCompressedTextureSubImage2D(uint texture, int level, int xoffset, int yoffset, int width, int height, InternalFormat format, int imageSize, IntPtr data);
		internal delegate void glCompressedTextureSubImage2DEXT(uint texture, TextureTarget target, int level, int xoffset, int yoffset, int width, int height, InternalFormat format, int imageSize, IntPtr bits);
		internal delegate void glCompressedTextureSubImage3D(uint texture, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth, InternalFormat format, int imageSize, IntPtr data);
		internal delegate void glCompressedTextureSubImage3DEXT(uint texture, TextureTarget target, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth, InternalFormat format, int imageSize, IntPtr bits);
		...
		internal delegate void glCoverageMaskNV(Boolean mask);
		...
		internal unsafe delegate void glEdgeFlagPointerEXT(int stride, int count, Boolean* pointer);
		internal unsafe delegate void glEdgeFlagPointerListIBM(int stride, bool** pointer, int ptrstride);
		internal unsafe delegate void glEdgeFlagv(Boolean* flag);
		...
		internal unsafe delegate void glGetActiveAttribARB(uint programObj, uint index, int maxLength, int* length, int* size, AttributeType* type, StringBuilder name);
		internal unsafe delegate void glGetActiveSubroutineName(uint program, ShaderType shadertype, uint index, int bufSize, int* length, StringBuilder name);
		...
		internal unsafe delegate void glGetActiveSubroutineUniformName(uint program, ShaderType shadertype, uint index, int bufSize, int* length, StringBuilder name);
		...
		internal unsafe delegate void glGetActiveUniformARB(uint programObj, uint index, int maxLength, int* length, int* size, UniformType* type, StringBuilder name);
		...
		internal unsafe delegate void glGetActiveVaryingNV(uint program, uint index, int bufSize, int* length, int* size, uint* type, StringBuilder name);
		...
		internal unsafe delegate uint glGetDebugMessageLogAMD(uint count, int bufSize, uint* categories, DebugSeverity* severities, uint* ids, int* lengths, StringBuilder message);
		internal unsafe delegate uint glGetDebugMessageLogARB(uint count, int bufSize, DebugSource* sources, DebugType* types, uint* ids, DebugSeverity* severities, int* lengths, StringBuilder messageLog);
		...
		internal delegate void glGetHistogram(HistogramTargetEXT target, Boolean reset, PixelFormat format, PixelType type, IntPtr values);
		internal delegate void glGetHistogramEXT(HistogramTargetEXT target, Boolean reset, PixelFormat format, PixelType type, IntPtr values);
		...
		internal delegate ulong glGetImageHandleARB(uint texture, int level, Boolean layered, int layer, PixelFormat format);
		internal delegate ulong glGetImageHandleNV(uint texture, int level, Boolean layered, int layer, PixelFormat format);
		...
		internal unsafe delegate void glGetInvariantBooleanvEXT(uint id, GetVariantValueEXT value, Boolean* data);
		...
		internal unsafe delegate void glGetLocalConstantBooleanvEXT(uint id, GetVariantValueEXT value, Boolean* data);
		...
		internal delegate void glGetMapControlPointsNV(EvalTargetNV target, uint index, MapTypeNV type, int ustride, int vstride, Boolean packed, IntPtr points);
		...
		internal delegate void glGetMinmax(MinmaxTargetEXT target, Boolean reset, PixelFormat format, PixelType type, IntPtr values);
		internal delegate void glGetMinmaxEXT(MinmaxTargetEXT target, Boolean reset, PixelFormat format, PixelType type, IntPtr values);
		...
		internal unsafe delegate void glGetVariantBooleanvEXT(uint id, GetVariantValueEXT value, Boolean* data);
		...
		internal delegate void glHistogram(HistogramTargetEXT target, int width, InternalFormat internalformat, Boolean sink);
		internal delegate void glHistogramEXT(HistogramTargetEXT target, int width, InternalFormat internalformat, Boolean sink);
		#endregion
		...
		internal delegate void glLoadIdentityDeformationMapSGIX(FfdMaskSGIX mask);
		...
		internal unsafe delegate IntPtr* glMapNamedBuffer(uint buffer, BufferAccessARB access);
		internal unsafe delegate IntPtr* glMapNamedBufferEXT(uint buffer, BufferAccessARB access);
		internal unsafe delegate IntPtr* glMapNamedBufferRange(uint buffer, IntPtr offset, int length, MapBufferAccessMask access);
		internal unsafe delegate IntPtr* glMapNamedBufferRangeEXT(uint buffer, IntPtr offset, int length, MapBufferAccessMask access);
		internal unsafe delegate IntPtr* glMapObjectBufferATI(uint buffer);
		...
		internal delegate void glMemoryBarrierEXT(MemoryBarrierMask barriers);
		internal unsafe delegate void glMemoryObjectParameterivEXT(uint memoryObject, MemoryObjectParameterName pname, int* @params);
		internal delegate void glMinmax(MinmaxTargetEXT target, InternalFormat internalformat, Boolean sink);
		internal delegate void glMinmaxEXT(MinmaxTargetEXT target, InternalFormat internalformat, Boolean sink);
		...
		internal delegate void glMulticastBlitFramebufferNV(uint srcGpu, uint dstGpu, int srcX0, int srcY0, int srcX1, int srcY1, int dstX0, int dstY0, int dstX1, int dstY1, ClearBufferMask mask, uint filter);
		...
		internal delegate void glMultiTexBufferEXT(TextureUnit texunit, TextureTarget target, InternalFormat internalformat, uint buffer);
		...
		internal delegate void glMultiTexImage1DEXT(TextureUnit texunit, TextureTarget target, int level, InternalFormat internalformat, int width, int border, PixelFormat format, PixelType type, IntPtr pixels);
		internal delegate void glMultiTexImage2DEXT(TextureUnit texunit, TextureTarget target, int level, InternalFormat internalformat, int width, int height, int border, PixelFormat format, PixelType type, IntPtr pixels);
		internal delegate void glMultiTexImage3DEXT(TextureUnit texunit, TextureTarget target, int level, InternalFormat internalformat, int width, int height, int depth, int border, PixelFormat format, PixelType type, IntPtr pixels);
		...
		internal unsafe delegate void glProgramUniformMatrix2dv(uint program, int location, int count, Boolean transpose, double* value);
		internal unsafe delegate void glProgramUniformMatrix2dvEXT(uint program, int location, int count, Boolean transpose, double* value);
		...
		internal unsafe delegate void glProgramUniformMatrix2fvEXT(uint program, int location, int count, Boolean transpose, float* value);
		internal unsafe delegate void glProgramUniformMatrix2x3dv(uint program, int location, int count, Boolean transpose, double* value);
		internal unsafe delegate void glProgramUniformMatrix2x3dvEXT(uint program, int location, int count, Boolean transpose, double* value);
		...
		internal unsafe delegate void glProgramUniformMatrix2x3fvEXT(uint program, int location, int count, Boolean transpose, float* value);
		internal unsafe delegate void glProgramUniformMatrix2x4dv(uint program, int location, int count, Boolean transpose, double* value);
		internal unsafe delegate void glProgramUniformMatrix2x4dvEXT(uint program, int location, int count, Boolean transpose, double* value);
		...
		internal unsafe delegate void glProgramUniformMatrix2x4fvEXT(uint program, int location, int count, Boolean transpose, float* value);
		internal unsafe delegate void glProgramUniformMatrix3dv(uint program, int location, int count, Boolean transpose, double* value);
		internal unsafe delegate void glProgramUniformMatrix3dvEXT(uint program, int location, int count, Boolean transpose, double* value);
		...
		internal unsafe delegate void glProgramUniformMatrix3fvEXT(uint program, int location, int count, Boolean transpose, float* value);
		internal unsafe delegate void glProgramUniformMatrix3x2dv(uint program, int location, int count, Boolean transpose, double* value);
		internal unsafe delegate void glProgramUniformMatrix3x2dvEXT(uint program, int location, int count, Boolean transpose, double* value);
		...
		internal unsafe delegate void glProgramUniformMatrix3x2fvEXT(uint program, int location, int count, Boolean transpose, float* value);
		internal unsafe delegate void glProgramUniformMatrix3x4dv(uint program, int location, int count, Boolean transpose, double* value);
		internal unsafe delegate void glProgramUniformMatrix3x4dvEXT(uint program, int location, int count, Boolean transpose, double* value);
		...
		internal unsafe delegate void glProgramUniformMatrix3x4fvEXT(uint program, int location, int count, Boolean transpose, float* value);
		internal unsafe delegate void glProgramUniformMatrix4dv(uint program, int location, int count, Boolean transpose, double* value);
		internal unsafe delegate void glProgramUniformMatrix4dvEXT(uint program, int location, int count, Boolean transpose, double* value);
		...
		internal unsafe delegate void glProgramUniformMatrix4fvEXT(uint program, int location, int count, Boolean transpose, float* value);
		internal unsafe delegate void glProgramUniformMatrix4x2dv(uint program, int location, int count, Boolean transpose, double* value);
		internal unsafe delegate void glProgramUniformMatrix4x2dvEXT(uint program, int location, int count, Boolean transpose, double* value);
		...
		internal unsafe delegate void glProgramUniformMatrix4x2fvEXT(uint program, int location, int count, Boolean transpose, float* value);
		internal unsafe delegate void glProgramUniformMatrix4x3dv(uint program, int location, int count, Boolean transpose, double* value);
		internal unsafe delegate void glProgramUniformMatrix4x3dvEXT(uint program, int location, int count, Boolean transpose, double* value);
		...
		internal unsafe delegate void glProgramUniformMatrix4x3fvEXT(uint program, int location, int count, Boolean transpose, float* value);
		...
		internal delegate void glRasterSamplesEXT(uint samples, Boolean fixedsamplelocations);
		...
		internal delegate void glSampleCoverageARB(float value, Boolean invert);
		internal delegate void glSampleCoveragex(int value, Boolean invert);
		internal delegate void glSampleCoveragexOES(int value, Boolean invert);
		internal delegate void glSampleMapATI(uint dst, uint interp, SwizzleOpATI swizzle);
		internal delegate void glSampleMaskEXT(float value, Boolean invert);
		...
		internal delegate void glSampleMaskSGIS(float value, Boolean invert);
		...
		internal delegate void glTexBufferARB(TextureTarget target, SizedInternalFormat internalformat, uint buffer);
		...
		internal delegate void glTexImage1D(TextureTarget target, int level, InternalFormat internalformat, int width, int border, PixelFormat format, PixelType type, IntPtr pixels);
		...
		internal delegate void glTexImage2DMultisample(TextureTarget target, int samples, InternalFormat internalformat, int width, int height, Boolean fixedsamplelocations);
		internal delegate void glTexImage2DMultisampleCoverageNV(TextureTarget target, int coverageSamples, int colorSamples, InternalFormat internalFormat, int width, int height, Boolean fixedSampleLocations);
		...
		internal delegate void glTexImage3DMultisample(TextureTarget target, int samples, InternalFormat internalformat, int width, int height, int depth, Boolean fixedsamplelocations);
		internal delegate void glTexImage3DMultisampleCoverageNV(TextureTarget target, int coverageSamples, int colorSamples, InternalFormat internalFormat, int width, int height, int depth, Boolean fixedSampleLocations);
		...
		internal delegate void glTexStorage1D(TextureTarget target, int levels, SizedInternalFormat internalformat, int width);
		...
		internal delegate void glTexStorage3DMultisampleOES(TextureTarget target, int samples, SizedInternalFormat internalformat, int width, int height, int depth, Boolean fixedsamplelocations);
		...
		internal delegate void glTexStorageMem2DMultisampleEXT(TextureTarget target, int samples, SizedInternalFormat internalFormat, int width, int height, Boolean fixedSampleLocations, uint memory, ulong offset);
		...
		internal delegate void glTexStorageMem3DMultisampleEXT(TextureTarget target, int samples, SizedInternalFormat internalFormat, int width, int height, int depth, Boolean fixedSampleLocations, uint memory, ulong offset);
		internal delegate void glTexStorageSparseAMD(TextureTarget target, SizedInternalFormat internalFormat, int width, int height, int depth, int layers, TextureStorageMaskAMD flags);
		...
		internal delegate void glTextureBuffer(uint texture, SizedInternalFormat internalformat, uint buffer);
		internal delegate void glTextureBufferEXT(uint texture, TextureTarget target, SizedInternalFormat internalformat, uint buffer);
		internal delegate void glTextureBufferRange(uint texture, SizedInternalFormat internalformat, uint buffer, IntPtr offset, int size);
		internal delegate void glTextureBufferRangeEXT(uint texture, TextureTarget target, SizedInternalFormat internalformat, uint buffer, IntPtr offset, int size);
		internal delegate void glTextureColorMaskSGIS(Boolean red, Boolean green, Boolean blue, Boolean alpha);
		...
		internal delegate void glTextureImage1DEXT(uint texture, TextureTarget target, int level, InternalFormat internalformat, int width, int border, PixelFormat format, PixelType type, IntPtr pixels);
		internal delegate void glTextureImage2DEXT(uint texture, TextureTarget target, int level, InternalFormat internalformat, int width, int height, int border, PixelFormat format, PixelType type, IntPtr pixels);
		internal delegate void glTextureImage2DMultisampleCoverageNV(uint texture, TextureTarget target, int coverageSamples, int colorSamples, InternalFormat internalFormat, int width, int height, Boolean fixedSampleLocations);
		internal delegate void glTextureImage2DMultisampleNV(uint texture, TextureTarget target, int samples, InternalFormat internalFormat, int width, int height, Boolean fixedSampleLocations);
		internal delegate void glTextureImage3DEXT(uint texture, TextureTarget target, int level, InternalFormat internalformat, int width, int height, int depth, int border, PixelFormat format, PixelType type, IntPtr pixels);
		internal delegate void glTextureImage3DMultisampleCoverageNV(uint texture, TextureTarget target, int coverageSamples, int colorSamples, InternalFormat internalFormat, int width, int height, int depth, Boolean fixedSampleLocations);
		internal delegate void glTextureImage3DMultisampleNV(uint texture, TextureTarget target, int samples, InternalFormat internalFormat, int width, int height, int depth, Boolean fixedSampleLocations);
		...
		internal delegate void glTextureStorage1D(uint texture, int levels, SizedInternalFormat internalformat, int width);
		...
		internal delegate void glTextureStorage2D(uint texture, int levels, SizedInternalFormat internalformat, int width, int height);
		...
		internal delegate void glTextureStorage2DMultisample(uint texture, int samples, SizedInternalFormat internalformat, int width, int height, Boolean fixedsamplelocations);
		internal delegate void glTextureStorage2DMultisampleEXT(uint texture, TextureTarget target, int samples, SizedInternalFormat internalformat, int width, int height, Boolean fixedsamplelocations);
		internal delegate void glTextureStorage3D(uint texture, int levels, SizedInternalFormat internalformat, int width, int height, int depth);
		...
		internal delegate void glTextureStorage3DMultisample(uint texture, int samples, SizedInternalFormat internalformat, int width, int height, int depth, Boolean fixedsamplelocations);
		internal delegate void glTextureStorage3DMultisampleEXT(uint texture, uint target, int samples, SizedInternalFormat internalformat, int width, int height, int depth, Boolean fixedsamplelocations);
		...
		internal delegate void glTextureStorageMem2DMultisampleEXT(uint texture, int samples, SizedInternalFormat internalFormat, int width, int height, Boolean fixedSampleLocations, uint memory, ulong offset);
		...
		internal delegate void glTextureStorageMem3DMultisampleEXT(uint texture, int samples, SizedInternalFormat internalFormat, int width, int height, int depth, Boolean fixedSampleLocations, uint memory, ulong offset);
		internal delegate void glTextureStorageSparseAMD(uint texture, uint target, SizedInternalFormat internalFormat, int width, int height, int depth, int layers, TextureStorageMaskAMD flags);
		...
		internal delegate void glTextureView(uint texture, TextureTarget target, uint origtexture, SizedInternalFormat internalformat, uint minlevel, uint numlevels, uint minlayer, uint numlayers);
		...
		internal unsafe delegate void glUniformMatrix2dv(int location, int count, Boolean transpose, double* value);
		internal unsafe delegate void glUniformMatrix2fv(int location, int count, Boolean transpose, float* value);
		internal unsafe delegate void glUniformMatrix2fvARB(int location, int count, Boolean transpose, float* value);
		internal unsafe delegate void glUniformMatrix2x3dv(int location, int count, Boolean transpose, double* value);
		internal unsafe delegate void glUniformMatrix2x3fv(int location, int count, Boolean transpose, float* value);
		internal unsafe delegate void glUniformMatrix2x3fvNV(int location, int count, Boolean transpose, float* value);
		internal unsafe delegate void glUniformMatrix2x4dv(int location, int count, Boolean transpose, double* value);
		internal unsafe delegate void glUniformMatrix2x4fv(int location, int count, Boolean transpose, float* value);
		internal unsafe delegate void glUniformMatrix2x4fvNV(int location, int count, Boolean transpose, float* value);
		internal unsafe delegate void glUniformMatrix3dv(int location, int count, Boolean transpose, double* value);
		internal unsafe delegate void glUniformMatrix3fv(int location, int count, Boolean transpose, float* value);
		internal unsafe delegate void glUniformMatrix3fvARB(int location, int count, Boolean transpose, float* value);
		internal unsafe delegate void glUniformMatrix3x2dv(int location, int count, Boolean transpose, double* value);
		internal unsafe delegate void glUniformMatrix3x2fv(int location, int count, Boolean transpose, float* value);
		internal unsafe delegate void glUniformMatrix3x2fvNV(int location, int count, Boolean transpose, float* value);
		internal unsafe delegate void glUniformMatrix3x4dv(int location, int count, Boolean transpose, double* value);
		internal unsafe delegate void glUniformMatrix3x4fv(int location, int count, Boolean transpose, float* value);
		internal unsafe delegate void glUniformMatrix3x4fvNV(int location, int count, Boolean transpose, float* value);
		internal unsafe delegate void glUniformMatrix4dv(int location, int count, Boolean transpose, double* value);
		internal unsafe delegate void glUniformMatrix4fv(int location, int count, Boolean transpose, float* value);
		internal unsafe delegate void glUniformMatrix4fvARB(int location, int count, Boolean transpose, float* value);
		internal unsafe delegate void glUniformMatrix4x2dv(int location, int count, Boolean transpose, double* value);
		internal unsafe delegate void glUniformMatrix4x2fv(int location, int count, Boolean transpose, float* value);
		internal unsafe delegate void glUniformMatrix4x2fvNV(int location, int count, Boolean transpose, float* value);
		internal unsafe delegate void glUniformMatrix4x3dv(int location, int count, Boolean transpose, double* value);
		internal unsafe delegate void glUniformMatrix4x3fv(int location, int count, Boolean transpose, float* value);
		internal unsafe delegate void glUniformMatrix4x3fvNV(int location, int count, Boolean transpose, float* value);
		...
		internal unsafe delegate IntPtr glVDPAURegisterVideoSurfaceWithPictureStructureNV(IntPtr vdpSurface, uint target, int numTextureNames, uint* textureNames, Boolean isFrameStructure);
		...
		internal delegate void glVertexArrayAttribFormat(uint vaobj, uint attribindex, int size, VertexAttribType type, Boolean normalized, uint relativeoffset);
		...
		internal delegate void glVertexArrayVertexAttribFormatEXT(uint vaobj, uint attribindex, int size, VertexAttribType type, Boolean normalized, uint relativeoffset);
		...
		internal delegate void glVertexArrayVertexAttribOffsetEXT(uint vaobj, uint buffer, uint index, int size, VertexAttribPointerType type, Boolean normalized, int stride, IntPtr offset);
		...
		internal delegate void glVertexAttribArrayObjectATI(uint index, int size, VertexAttribPointerType type, Boolean normalized, int stride, uint buffer, uint offset);
		...
		internal delegate void glVertexAttribFormatNV(uint index, int size, VertexAttribType type, Boolean normalized, int stride);
		...
		internal delegate void glVertexAttribP1ui(uint index, VertexAttribPointerType type, Boolean normalized, uint value);
		internal unsafe delegate void glVertexAttribP1uiv(uint index, VertexAttribPointerType type, Boolean normalized, uint* value);
		internal delegate void glVertexAttribP2ui(uint index, VertexAttribPointerType type, Boolean normalized, uint value);
		internal unsafe delegate void glVertexAttribP2uiv(uint index, VertexAttribPointerType type, Boolean normalized, uint* value);
		internal delegate void glVertexAttribP3ui(uint index, VertexAttribPointerType type, Boolean normalized, uint value);
		internal unsafe delegate void glVertexAttribP3uiv(uint index, VertexAttribPointerType type, Boolean normalized, uint* value);
		internal delegate void glVertexAttribP4ui(uint index, VertexAttribPointerType type, Boolean normalized, uint value);
		internal unsafe delegate void glVertexAttribP4uiv(uint index, VertexAttribPointerType type, Boolean normalized, uint* value);
		...
		internal delegate void glVertexAttribPointerARB(uint index, int size, VertexAttribPointerType type, Boolean normalized, int stride, IntPtr pointer);
