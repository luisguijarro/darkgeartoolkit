...
namespace dgtk.Platforms.EGL
{
	...
	public enum EGL_ERRORS : int
	{
		EGL_SUCCESS = EGL_ENUM.EGL_SUCCESS,
		EGL_NOT_INITIALIZED = EGL_ENUM.EGL_NOT_INITIALIZED,
		EGL_BAD_ACCESS = EGL_ENUM.EGL_BAD_ACCESS,
		EGL_BAD_ALLOC = EGL_ENUM.EGL_BAD_ALLOC,
		EGL_BAD_ATTRIBUTE = EGL_ENUM.EGL_BAD_ATTRIBUTE,
		EGL_BAD_CONTEXT = EGL_ENUM.EGL_BAD_CONTEXT,
		EGL_BAD_CONFIG = EGL_ENUM.EGL_BAD_CONFIG,
		EGL_BAD_CURRENT_SURFACE = EGL_ENUM.EGL_BAD_CURRENT_SURFACE,
		EGL_BAD_DISPLAY = EGL_ENUM.EGL_BAD_DISPLAY,
		EGL_BAD_SURFACE = EGL_ENUM.EGL_BAD_SURFACE,
		EGL_BAD_MATCH = EGL_ENUM.EGL_BAD_MATCH,
		EGL_BAD_PARAMETER = EGL_ENUM.EGL_BAD_PARAMETER,
		EGL_BAD_NATIVE_PIXMAP = EGL_ENUM.EGL_BAD_NATIVE_PIXMAP,
		EGL_BAD_NATIVE_WINDOW = EGL_ENUM.EGL_BAD_NATIVE_WINDOW,
		EGL_CONTEXT_LOST = EGL_ENUM.EGL_CONTEXT_LOST,
	}
	...
	public enum EGL_ENUM : int
	{
		...
		EGL_NONE = 0x00003038,// Attribute list terminator
