...
namespace dgtk.Platforms.X11
{
    internal static class Imports
    {
        ...
        [DllImport("libX11.so.6", EntryPoint = "XLockDisplay")]
		...
		[DllImport("libX11.so.6", EntryPoint = "XEventsQueued")]
		...
		[DllImport("libX11.so.6", EntryPoint = "XUnlockDisplay")]
		...
		[DllImport("libX11.so.6", EntryPoint = "XCreateColormap")]
		...
		[DllImport("libX11.so.6", EntryPoint = "XSynchronize")]
		...
		[DllImport("libX11.so.6", EntryPoint = "XCheckTypedWindowEvent")]
		...
		[DllImport("libX11.so.6", EntryPoint = "XLookupString", CallingConvention = CallingConvention.Cdecl)]
		...
		//[DllImport("libX11.so.6", EntryPoint = "XmbLookUpString")]
		...
		[DllImport("libX11.so.6", EntryPoint = "XIconifyWindow")]
        ...
        [DllImport("libX11.so.6", EntryPoint = "XDefaultVisual")]
		...
		[DllImport("libX11.so.6", EntryPoint = "XGetIMValues")]
		...
		[DllImport("libX11.so.6", EntryPoint = "XKeysymToString")]
		internal extern static IntPtr XKeysymToString(ulong keysym);

		[DllImport("libX11.so.6", EntryPoint = "XSetLocaleModifiers")]
