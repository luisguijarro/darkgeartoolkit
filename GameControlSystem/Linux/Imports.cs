...
namespace dgtk.GameControlSystem.Linux
{
    internal class Imports
    {
        ...
        [DllImport("libevdev.so.2", EntryPoint = "libevdev_get_uniq")]
        internal static extern string libevdev_get_uniq (IntPtr dev); //Obtener identificador único de dispositivo.

        [DllImport("libevdev.so.2", EntryPoint = "libevdev_get_name")]
        internal static extern string libevdev_get_name (IntPtr dev);

        [DllImport("libevdev.so.2", EntryPoint = "libevdev_has_event_type")]
        ...
        [DllImport("libevdev.so.2", EntryPoint = "libevdev_has_event_code")]
        ...
        [DllImport("libevdev.so.2", EntryPoint = "libevdev_get_abs_minimum")]
        internal static extern int libevdev_get_abs_minimum (IntPtr dev, uint code); 	

        [DllImport("libevdev.so.2", EntryPoint = "libevdev_get_abs_maximum")]
        internal static extern int libevdev_get_abs_maximum (IntPtr dev, uint code); 	

        [DllImport("libevdev.so.2", EntryPoint = "libevdev_free")]
